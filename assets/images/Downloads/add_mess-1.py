...
✨በዚህ ፕላትፎርም ሁሉም ስራዎች የሚሰሩት በኦንላይን ባሉበት ሆነው ነው።\n\nቋንቋዎን ለመቀየር የ /language ን አዝራር ይጫኑ""",
    "afaan_oromoo": """Gara plaatfoormii Maroset baga nagaan dhuftan, plaatfoormiin kun namoonni osoo bakki isaan hin daangeesssin bakkuma jiranitti karaa onlinerraan hojiilee fagoo irratti qacaramanii kan itti hojjatan, akkasumas hojjachistoonnis salphumatti ogeessoota barbaadan qacaruu kan itti danda'aniidha.\n\n
  "procces_canceled": {
    ...
    "my_company": {
      "english": "My Company",
      "amharic": "ድርጅቶቼ",
      "afaan_oromoo": "Kubbaanniyaawwankoo"
    },
    "setting": {
      "english": "Setting",
      "amharic": "ዝርዝር/",
  ...
  #Job Posting Messages
    ...
    "ask_job_responsibilities": {
        ...
        "orafaan_oromoo": "Gahee fi itti gaafatamummaa hojichaa(Yoo hin jiraanne darbaa)"
    },
    "send_your_new_text": {
  ...
  "talk_to_user": {
    ...
    "term_and_condition": {
        ...
        "amharic": "ሕግ እና ደንቦች",
        "afaan_oromoo": "Seeraa fi danbiiwwan",
        },
      "remove": {
          "english": "Remove",
          "amharic": "ያጥፉ",
  ...
  "ask_to_join_channel": {
      ...
      "amharic": "A Join: <a href='https://t.me/+tU8xZvbddBA3Yzdk'>Maroset</a>\nመጀመርያ ቻናሉን መቀላቀል አለብዎት",
      "afaan_oromoo": "Makamaa: <a href='https://t.me/+tU8xZvbddBA3Yzdk'>Maroset</a>\nDursa chaanaalichatti makamuu qabdu"
  },
  "ask_name": {
  ...
  "invalid_name": {
      "english": "Please Write your full name correclty!",
  ...
  "ask_to_attach_phone": {
      ...
      "amharic": "ይህንን ስልክ ቁጥር የራስዎ ግለታሪክ ላይ ማካተት ይፈልጋሉ?(በኋላ setting ውስጥ መቀየር ይችላሉ)\n=> +{number}",
      "afaan_oromoo": "Lakkoofsa bilbila kanaa proofaayila keessan waliin hidhuu barbaadduu? (Booddee setting keesssatti jijjiiruu dandeessu)\n=> +{number}"
  },
  "ask_email": {
  ...
  "ask_email_from_setting": {
      ...
      "afaan_oromoo": "Email keessan ergaa."
  },
  "invalid_email": {
      "english": "Invalid Input, send a valid email!",
  ...
  "ask_cv": {
      ...
      "amharic": "እባክዎ CVዎትን ይላኩ(CVዎ በ .pdf , በ.doc ወይም በ .docx አይነት መሆን አለበት",
      "afaan_oromoo": "Maaloo CV keessan ergaa. Cvn ergitan gosoota .pdf, .doc yookin .docx ta'uu qaba"
  },
  "invalid_cv": {
  ...
  "type_your_message_for_admin": {
      ...
      "afaan_oromoo": "Bulchaa plaatformichaatif ergaa barreessaa"
  },
  "type_your_message_for_user": {
    ...
    "applying_message": {
        "english": "Type Your application for job owner", 
        "amharic": "የስራ ማመልከቻዎን ለስራው ባለቤት ይላኩ:",
        "afaan_oromoo": "Iyyata hojii keessanii abbaa hojichaatif ergaa:"
    },
    "confirm_applying_without_cv": {
        "english": "You don't have cv, you can upload your cv by clicking the 'upload cv' button below or you can send it without cv \nDo you want to send this job application?", 
        "amharic": "CV የለዎትም CVዎን ለመጫን Upload CV የሚለውን አዝራር በመጠቀም መጫን ይችላሉ ሆኖም ማመልከቻዎን ያለ CVም መላክ ይችላሉ",
        "afaan_oromoo": "CV hin qabdanu, Cv keessan qabduu asii gadii kan'upload cv' jedhu cuqaasun erguu dandeessu yookin CV malees erguu dandeessu \nIyyata hojii kana erguu barbaadduu?"
    },
    "confirm_applying_with_cv": {
        ...
        "afaan_oromoo": "Ergaa kana erguu barbaadduu? Cvn keessanis itti dabalama!"
    },
  ...
  "only_text_are_allowed_when_applying": {
      "english": "Only text are allowed when applying!", 
    ...
    "applied_successfully": {
        ...
        "afaan_oromoo": "Iyyanni keessan milkaa'iannaan gara abbaa hojichaatti gulalaaf ergameera!",
    "ask_to_close_job_and_broadcast": {
        "english": "Do you want to close this job?\nYou can send message/broadcast to all users who have applied to to this job that they didn't get the job or somthing!", 
        ...
        "afaan_oromoo": "Hojii kana cufuu barbaadduu?\nYoo ta'e maaloo iyyatttoota hojii kanaaf iyyatanii garuu hin filatamneef, filatamuu dhabuu isaanii fi yeroo biraatif waan foyyeessuuu qaban hundumaafuu si'a tokkoon ergaa erguun beeksisaa!\n(Hubachiisa:Kana gochuun dirqama keessanii dha!)"
    },
    "send_the_broadcast_message": {
        "english": "Send the message you want to send to the users.", 
    ...
    "manage_company": {
      ...
      "afaan_oromoo": "Kubbaaniyaa hoogganuu"
    },
    "company_page_message": {
      "english": "You can create and manage Company here!",
      "amharic": "እዚህ ኩባንያ መስገባት እና ማስተዳደር ይችላሉ!",
      "afaan_oromoo": "Asitti kubbaaniyaa galchuu fi hoogganuu dandeessu!"
    },
    "you_dont_have_registerd_company": {
      "english": "You currently don't have registerd company/startup!\nstart by registering one",
      "amharic": "እስካሁን የተመዘገበ ኩባንያም ሆነ ጀማሪ ድርጅት/Startup የለዎትም!\nstart by registering one",
      "afaan_oromoo": "Ammatti Kubbaaniyaa galmaa'e hin qabdanu/startup!\nGalmeessuun jalqabaa"
    },
    "company": {
      "english": "Company",
      "amharic": "ኩባንያ",
      "afaan_oromoo": "Kubbaaniyaa"
    },
    "startup": {
      "english": "Startup",
      "amharic": "ጀማሪ ድርጅት",
    ...
    "ask_company_type": {
      ...
      "amharic": "የኩባንያዎን ስም ይላኩ",
      "afaan_oromoo": "Maqaa Kubbaaniyaa keessan ergaa"
    },
    "ask_company_logo": {
      "english": "Send the company logo(as picture)",
      "amharic": "የኩባንያዎን አርማ በምስል መልክ ይላኩ",
      "afaan_oromoo": "Asxaa/Faajjii Kubbaaniyaa keessan ergaa(Fakkiidhan)"
    },
    "ask_industry_field": {
      ...
      "amharic": "የኩባንያዎን ሴክተር ከዚህ በታች ከተዘረዘሩት መካከል ይምረጡ, የኩባንያዎትን ሴክተር ከተዘረዘሩት መካከል ካላገኙ, እባክዎ ለምደባ ይጠቅመን ዘንድ ከታች ባለው ባዶ ቦታ ፅፈው ይላኩልን",
      "afaan_oromoo": "Seektara Kubbaaniyaa keessanii filadhaa, Kanneen asii gadiitti tarreeffaman keessaa yoo Seektara keessan dhabdan, maaloo asii gadiitti maqaa seektara keessan nuf barreessaa. Ramaddii seektarootaatif nu fayyada"
    },
    "ask_established_year": {
      "english": "Send the year of establishment\nUse this format 2023-05-24",
      "amharic": "ኩባንያዎት የተመሰረተበትን ዓ.ም ይላኩልን (እባክዎ ይህንን ይከተሉ->ዓ.ም/ወር/ቀን",
      "afaan_oromoo": "Yeroo iitti hundaa'et\nFoormaatii kanaan nuf ergaa->bara/ji'a/guyyaa"
    },
    "ask_company_email": {
      "english": "send the company email",
      "amharic": "የኩባንያዎን የ ኢሜይል አድራሻ ይላኩ",
      "afaan_oromoo": "I-Maayilii/E-Mail ergaa"
    },
    "ask_company_website": {
      "english": "Send the company website",
      "amharic": "የኩባንያዎን ድህረገፅ ይላኩ",
      "afaan_oromoo": "Marsaaritii Kubbaaniyaa keessanii ergaa"
    },
    "ask_company_phone": {
      "english": "Send the company phone number\nPlease use this format +251",
      "amharic": "የኩባንያዎን ስልክ ቁጥር ይላኩ\nእባክዎ ይህን ይከተሉ +251",
      "afaan_oromoo": "Lakkoofsa bilbila Kubbaaniyaa keessanii ergaa\nMaaloo formaatii kana fayyadamaa +251"
    },
    "ask_company_country": {
      "english": "Select the company's country",
      "amharic": "ኩባንያዎ የሚገኝበትን ሀገር ይምረጡ",
      "afaan_oromoo": "Biyya Kubbaaniyichaa filadhaa"
    },
    "type_company_country": {
      "english": "Type the country of the company",
      "amharic": "ኩባንያዎ የሚገኝበትን ሀገር ይፃፉ",
      "afaan_oromoo": "Biyya Kubbaaniyichaa barreessaa"
    },
    "ask_company_city": {
      "english": "Select the company's city",
      "amharic": "ኩባንያዎ የሚገኝበትን ከተማ ይምረጡ",
      "afaan_oromoo": "Magaalaa Kubbaniyichaa filadhaa"
    },
    "type_company_city": {
      "english": "Type the company's city",
      "amharic": "ኩባንያዎ የሚገኝበትን ከተማ ይፃፉ",
      "afaan_oromoo": "Magaalaa Kubbaaniyichaa barreessaa"
    },
    "ask_company_postal_code": {
      "english": "Send the company's postal code",
      "amharic": "የኩባንያዎን የ ፖስታ ሳጥን ቁጥር ይላኩ",
      "afaan_oromoo": "Lakkoofsa saanduqa poostaa Kubbaniyichaa ergaa"
    },
    "ask_company_tin_number": {
      "english": "Send the company's tin number\nNote that we wouldn't share this with other users",
      "amharic": "የኩባንያዎን የግብር መለያ ቁጥር/TIN ይላኩ",
      "afaan_oromoo": "Laakkooofsa TIN Kubbanniyichaa ergaa\Hubachiisa: odeeffannoon kun qaama saddaffaatif hin qoodamu"
    },
    "ask_company_trade_license": {
      "english": "Send the company's trade license(send it as image)\nNote that we wouldn't share this with other users",
      "amharic": "የኩባንያዎን የንግድ ፍቃድ በምስል መልክ ይላኩ",
      "afaan_oromoo": "Eeyyama daldala Kukeessanii ergaa(Fakkiidhan)\nHubachiisa: odeeffannoon kun qaama saddaffaatif hin qoodamu"
    },
    "ask_company_detail": {
      "english": "Send discription about the company it should have atleast 13 < words",
      "amharic": "ስለኩባንያዎ ማብራርያ ይፃፉ (ማብራርያው ቢያንስ 13 ቃላት እና ከዛ በላይ መሆን አለበት)",
      "afaan_oromoo": "Ibsa waa'ee Kubbanniyichaa barreessaa, ibsi kun yoo xiqqaate jechoota 13 yookin isaan ol ta'uu qaba"
    },
    "ask_social_links": {
      "english": "Add your social links",
    ...
    "invalid_phone": {
      ...
      "afaan_oromoo": "Galtee hin taane!\nMFormaatii ida'uu (+)tin jalqabuu keesssanii fi baay'ini diijitii 13 ta'uu isaa mirkaneessaa"
    },
    "invalid_country": {
      "english": "Use only the buttons to choose country!",
      "amharic": "የተሳሳተ መረጃ! እባክዎ የተቀመጡትን አዝራሮች ብቻ ተጠቅመው ሀገርዎን ይምረጡ!",
      "afaan_oromoo": "Maaloo biyya filachuuf qabduuwwaan asii gadii qofa fayyadamaa!"
    },
    "invalid_postal_code": {
      ...
      "afaan_oromoo": "Galtee hin taane!\nBaay'ini isaa 4-12 fi hundumtuu lakkoofsoota ta'uu qaba"
    },
    "invalid_tin_number": {
      ...
      "afaan_oromoo": "O Invalid input!\nBaay'ini isaa shanii olii fi hundumtuu lakkofsoota ta'uu qaba"
    },
    ...
    "The company has been sent to admin": {
      "english": "The company has been sent to admin!",
      "amharic": "ያስመዘገቡት ኩባንያ ለግምገማ ወደ Maroset አተዳዳሪዎች ተልኳል!",
      "afaan_oromoo": "Kuubbaaniyaan galmeestitan gara bulchitoota Maroset itti ergameera!"
    },
    "warning_company": {
    ...
    "this_company_has_been_approved": {
      "english": "This company has been approved!",
      "amharic": "እንኳን ደስ ያልዎት! ኩባንያዎ ፀድቆልዎታል!",
      "afaan_oromoo": "Kubbaanniyaan kun mirkanaa'eera!"
    },
    ...
    "your_company_has_been_rejected": {
      "english": "Your company has been rejected.",
      "amharic": "ይቅርታ! ኩባንያዎት አልፀደቀልዎትም",
      "afaan_oromoo": "Maaloo Kuubbaaniyaan keessan hin mirkanoofne."
    },
    "are_you_sure_you_want_to_delete_this_company": {
      "english": "Do you really want to delete your company from the maroset bot!!",
      "amharic": "እርግጠኛ ኖት ኩባንያዎትን ከ Maroset ቦት ላይ ማጥፋት ፈልገዋል?",
      "afaan_oromoo": "Bootii Maroset irraa Kuabbaaniyaa keessan Haquu/delete barbaadduu?"
    },
    ...
    "ask_founders_name": {
      ...
      "amharic": "የመስራቾችን እና ወሳኝ አባላትት መደበኛ እና ሙሉ ስም ይላኩ\nበአዲስ መስመር ላይ ይፃፉ",
    ...
    "invalid_founders_name": {
      ...
      "amharic": "የተሳሳተ ስም!\nእባክዎ በትክክል ያስገቡ ለምሳሌ አቢይ አህመድ, አዳነች አቤቤ",
      "afaan_oromoo": "Galtee hin taane!\nMaqaa guutuu tokkoon tokkoo sarara haaraa irratti barreessaa, fakkeenyaaf:\nAbiy Ahmed\nAdanech Abebe\nSahle-Work Zewde"
    },"ask_the_startup_name": {
          "english": "Send the startup name",
          "amharic": "የጀማሪ ድርጅትዎን ስም ይላኩ",
          "afaan_oromoo": "Maqaa kuubbaaniyaa eegalaa ergaa"
        },
        "ask_startup_logo": {
          "english": "Send the logo logo(as picture)",
          "amharic": "የድርጅትዎን አርማ በምስል መልክ ያስገቡ",
          "afaan_oromoo": "Asxaa/Faajjii ergaa(Fakkiidhan)"
        },
        "ask_startup_industry_field": {
          "english": "Select the startup sector, If you do not see your industry or sector listed, please write it in the space provided below. This will help us categorize your business accurately.",
          "amharic": "የድርጅትዎን ዘርፍ ከታች ከተዘረዘሩት መካከል ይምረጡ፥ የእርሶ ድርጅት ከተዘረዘሩት መካከል ከሌለ ለምደባ ይጠም ዘንድ በተቀመጠው ባዶ ቦታ ላይ ይፃፉ",
        ...
        "ask_startup_established_year": {
          "english": "Send the year of establishment\nUse this format 2023-05-24",
          "amharic": "ድርጅትዎ የተመሰረተበትን ጊዜ ይላኩ እባክዎ በዚህ መልኩ ዓ.ም/ወር/ቀን ይላኩ ",
          "afaan_oromoo": "Bara hundeeffama dhaabbata keessanii ergaat\nfoormaatii kana fayyadamaa 2023-05-24"
        },
        "ask_startup_email": {
          "english": "send the startup email",
          "amharic": "እባክዎ የድርጅትዎን የኢሜይል አድራሻ  ይላኩ",
          "afaan_oromoo": "Imayilii dhaabbata keessanii ergaa"
        },
        "ask_startup_website": {
          "english": "Send the startup website",
          "amharic": "የድርጅትዎን ድህረ-ገፅ ይላኩ",
          "afaan_oromoo": "Marsaaritii dhaabbata keessanii ergaa"
        },
        "ask_startup_phone": {
          "english": "Send the startup phone number\nUse this format +251",
          "amharic": "እባክዎ የድርጅትዎን የስልክ ቁጥር በዚህ መልኩ +251 ይላኩ",
        ...
        "ask_startup_country": {
          ...
          "amharic": "እባክዎ ድርጅትዎ የሚገኝበትን ሀገር ይምረጡ",
        ...
        "ask_startup_detail": {
          "english": "Send discription about the startup it should have atleast 13 < words",
          "amharic": "ስለድርጅትዎ ማብራርያ ይፃፉ የሚፅፉት ማብራርያ ቃላት ብዛት ከ 13 መብለጥ አለበት",
  ...
  "confirm_job_report": {
    "english": "Do you want to report it!!!",
    "amharic": "መክሰስ ፈልገዋል?",
    "afaan_oromoo": "Himachuu barbaaddaniirtuu?"
  },
  "reported_successfully": {
    "english": "You report has been sent to the admin!!!",
    "amharic": "ክስዎት ወደ አስተዳዳሪዎት በስኬት ተልኳል እናመሰግናለን",
    "afaan_oromoo": "Himannaan keessan gara bulchitoota Maroset itti ergameera, Galatoomaa!!"
  }
